...
# 
# ln -sf ~/repo/personal/my_config/.ackrc ~/.ackrc
# ln -sf ~/repo/personal/my_config/.bashrc ~/.bashrc
# ln -sf ~/repo/personal/my_config/.gitconfig ~/.gitconfig
# ln -sf ~/repo/personal/my_config/.gitignore ~/.gitignore
# ln -sf ~/repo/personal/my_config/.ignore ~/.ignore
# ln -sf ~/repo/personal/my_config/.zshrc ~/.zshrc
# ln -sf ~/repo/personal/my_config/.tmux.conf ~/.tmux.conf
# ln -sf ~/repo/personal/my_config/.fzf.bash ~/.fzf.bash
# ln -sf ~/repo/personal/my_config/.fzf.zsh ~/.fzf.zsh
# ln -sf ~/repo/personal/my_config/.rgignore ~/.rgignore
# ln -sf ~/repo/personal/my_config/nvim ~/.config/nvim
